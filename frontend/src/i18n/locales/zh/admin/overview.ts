    ...
    groups: {
      ...
      videoPricing: {
        ...
        seedance: {
          ...
          modelOverridesDescription: '各型号独立定价，仅显示支持的清晰度。留空表示该档位未开放，创建任务会被拒绝；明确填写 0 表示免费。Seedance-2.5 与 bytedance/seedance-2.5 共用价格。',
          independentMultiplier: '视频倍率独立',
          videoMultiplier: '视频独立倍率',
          modeHint: 'fflink 按输出秒数计费；bblabu 的 Seedance-2.5 另计上游回传的参考视频输入秒数。任务按创建时锁定的单价结算。',
          finalPricePreview: '最终每秒价格预览',
          notConfigured: '未配置',
        },
      },

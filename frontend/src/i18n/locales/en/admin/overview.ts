    ...
    groups: {
      ...
      videoPricing: {
        ...
        seedance: {
          ...
          modelOverridesDescription: 'Each model has independent prices and only its supported resolutions are shown. Leave a tier empty to disable it; enter 0 explicitly for free usage. Seedance-2.5 and bytedance/seedance-2.5 share prices.',
          independentMultiplier: 'Use independent video multiplier',
          videoMultiplier: 'Video multiplier',
          modeHint: 'fflink bills output seconds only. bblabu Seedance-2.5 also bills reference-video input seconds reported by the upstream. Tasks settle at the unit price locked at creation.',
          finalPricePreview: 'Final per-second price preview',
          notConfigured: 'Not configured',
        },
      },

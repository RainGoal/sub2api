export default {
    ...
    channels: {
      ...
      form: {
        ...
        invalidSeedanceSales: 'Select models and valid per-second sales prices. Resolution tiers must be supported, unique and nonnegative.',
        seedanceSalesHint: 'Set customer sales prices in USD/second by model and resolution. Group or user multipliers apply to sales. Manage supplier purchase costs on accounts. After saving, channel prices apply; missing model or resolution prices reject creation.',
        importSeedanceSales: 'Import legacy group prices',
        noLegacySeedanceSales: 'The selected groups have no Seedance prices to import.',
        seedanceSalesImported: 'Legacy prices loaded. Review and save the channel.',
        seedanceSalesImportFailed: 'Import failed. Check whether selected groups have conflicting legacy prices.',
        seedanceGroupHint: 'Manage Seedance sales prices in channel pricing and purchase costs on accounts. Group multipliers still affect customer charges. Legacy group prices remain compatible and can be imported into a channel.',
        seedanceLegacySales: 'Legacy group prices (read-only; superseded after channel migration)',

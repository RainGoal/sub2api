    ...
    settings: {
      ...
      site: {
        ...
        communityContact: {
          ...
          hint: 'Shown in the public QQ Group and console Contact dialogs. Entries are hidden when the group number, invitation URL, and QR image URL are all empty.',
          ...
          groupNumberHint: 'Digits only, up to 32 digits. Users can copy this number from the contact dialog.',
          ...
          errors: {
            ...
            groupNumberInvalid: 'The QQ group number must contain only digits, up to 32 digits.',

    ...
    settings: {
      ...
      site: {
        ...
        communityContact: {
          ...
          hint: 'Shown in the homepage Contact Support and console Contact dialogs. Set the group name to your QQ, Telegram, or other community name. Entries are hidden when the group number, invitation URL, and QR image URL are all empty.',
          groupNameZh: 'Group Name (Chinese)',
          groupNameEn: 'Group Name (English, optional)',
          descriptionZh: 'Group Description (Chinese)',
          descriptionEn: 'Group Description (English, optional)',
          groupNumber: 'Group Number (optional)',
          groupNumberHint: 'Digits only, up to 32 digits. If there is no group number, provide an invitation URL or QR image URL.',
          inviteUrl: 'Group Invitation URL',
          inviteUrlHint: 'Enter a full HTTP(S) invitation URL. Leave empty to hide the join button.',
          qrImageUrl: 'Group QR Code Image URL',
          qrImageUrlHint: 'Use an HTTP(S) image URL or a site path starting with /. If empty, a QR code can be generated from the invitation URL.',
          errors: {
            groupNameTooLong: 'Group names must not exceed 120 characters.',
            descriptionTooLong: 'Group descriptions must not exceed 1000 characters.',
            groupNumberInvalid: 'The group number must contain only digits, up to 32 digits.',
            inviteUrlInvalid: 'The invitation URL must be a full HTTP(S) URL without a username, password, control characters, or backslashes.',
            qrImageUrlInvalid: 'The QR image must use HTTP(S) or a site path starting with a single /, without a username, password, control characters, or backslashes.',
            urlTooLong: 'URLs must not exceed 2048 characters.',
          },
        },

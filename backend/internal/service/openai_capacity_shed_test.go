...
func TestOpenAIStreamKeepaliveOnlyFailureDoesNotRecordVisibleFirstToken(t *testing.T) {
	gin.SetMode(gin.TestMode)
	previousSettings, _ := gatewayForwardingCache.Load().(*cachedGatewayForwardingSettings)

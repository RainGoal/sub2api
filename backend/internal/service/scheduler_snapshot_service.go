...
func (s *SchedulerSnapshotService) handleBulkAccountEvent(ctx context.Context, payload map[string]any, seen map[batchSeenKey]struct{}) error {
	...
	for _, account := range accounts {
		...
		case PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformGrok, PlatformSeedance, PlatformKimi, PlatformZhipu, PlatformDeepseek:
...
func schedulerSnapshotPlatforms() [9]string {
	return [9]string{PlatformAnthropic, PlatformGemini, PlatformOpenAI, PlatformAntigravity, PlatformGrok, PlatformSeedance, PlatformKimi, PlatformZhipu, PlatformDeepseek}
}

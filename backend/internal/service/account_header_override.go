...
// Seedance 平台的 api_key 账号，以及 Grok 平台的 api_key / oauth 账号生效。
...
func (a *Account) IsHeaderOverrideEligible() bool {
	...
	switch a.Platform {
	case PlatformAnthropic, PlatformOpenAI, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformOpenCodeGo, PlatformSeedance:

...
func (s *APIKeyService) Create(ctx context.Context, userID int64, req CreateAPIKeyRequest) (*APIKey, error) {
	...
	if req.FallbackGroupID != nil {
		if _, err := s.validateFallbackBinding(ctx, userID, req.GroupID, req.FallbackGroupID); err != nil {
			return nil, err
		}
	}
	// 验证用户存在
...
func (s *APIKeyService) Update(ctx context.Context, id int64, userID int64, req UpdateAPIKeyRequest) (*APIKey, error) {
	...
	if err := s.applyFallbackUpdate(ctx, apiKey, req); err != nil {
		return nil, err
	}
	...
	fields.FallbackGroupID = req.FallbackGroupIDSet

...
func TestCallProvider_BasePath(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"anthropic origin", MonitorProviderAnthropic, "", "", "/v1/messages?beta=true"},
		{"anthropic prefix", MonitorProviderAnthropic, "", "/anthropic", "/anthropic/v1/messages?beta=true"},
		{"anthropic trailing slash", MonitorProviderAnthropic, "", "/anthropic/", "/anthropic/v1/messages?beta=true"},
		{"anthropic version", MonitorProviderAnthropic, "", "/anthropic/v1", "/anthropic/v1/messages?beta=true"},
		{"version lookalike", MonitorProviderAnthropic, "", "/anthropic/v10", "/anthropic/v10/v1/messages?beta=true"},
		{"encoded prefix", MonitorProviderAnthropic, "", "/tenant%2Fone/anthropic", "/tenant%2Fone/anthropic/v1/messages?beta=true"},

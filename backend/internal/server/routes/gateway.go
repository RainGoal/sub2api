...
func RegisterGatewayRoutes(
	...
	rootRoute := func(method, path string, limit gin.HandlerFunc, handler gin.HandlerFunc) {
		r.Handle(method, path, limit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), activeConnectionMiddleware, groupModelAllowlist, compositeTarget, requireGroupAnthropic, handler)
	}
	...
	codexDirect.Use(bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), activeConnectionMiddleware, groupModelAllowlist, compositeTarget, requireGroupAnthropic)
	{
	...
	rootRoute(http.MethodGet, "/videos/jobs/:request_id", bodyLimit, videoStatusHandler)
	rootRoute(http.MethodGet, "/videos/jobs/:request_id/content", bodyLimit, videoContentHandler)
	rootRoute(http.MethodDelete, "/videos/jobs/:request_id", bodyLimit, videoCancelHandler)
